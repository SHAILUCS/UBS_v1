...
public class FormSubmissionTest {
    ...
    public static void setup() {
        ...
        pagUrl = "https://www.google.com/";//"file://" + System.getProperty("user.dir") + "/website/home.html";
        driver.get(pagUrl);
    }
    ...
    public void testFillForm() throws InterruptedException {
    	...
    	Thread.sleep(2000);
    	FormSubmission.takeSnapShot(driver);
		 ...
		 * 
		 * assertEquals(5,formElements.size()); for (WebElement element : formElements){
		 * assertEquals(before.get(element.getAttribute("value")),
    ...
    public void testSubmitForm() {
		 ...
		 * assertEquals(after.get(element.getAttribute("placeholder")),
		 * element.getAttribute("id")); }
		 */
    }
